export const Experience = [{
  title: 'Software Engineer @ Wix.com (Jan 2014 - Present)',
  image: 'wix.png',
  content: [
    'Front-end developer using the newest technologies',
    'Using the Angular framework with 3rd party libraries to build rich and dynamic UI.',
    'Using development environment technologies and build system tools such as The Angular framework, Grunt, Bower, Sass/Compass etc.',
    'Developing TDD with supportive technologies such as Karma, Jasmine, Protractor etc.',
    'Source control using Git & Github, collaborate with the open source community.',
    'Real user monitor using NewRelic and implementing a supportive library.'
  ]
}, {
  title: 'Monitoring Product Manager @ Mamram (Mar 2012 - Jan 2014)',
  content: [
    'Planning and implementing HP BSM solution (version 9.2) in an IT organization.',
    'Understanding DC systems architecture and implementation within the BSM Platform.',
  ...
  title: 'CM Team Leader @ Mamram (Nov 2010 - Mar 2012)',
  content: [
    'Hands on CM Team member, Leading up to 4 team members.',
    'Integration with related organizations and teams managing the current workflow and future strategies of development.'
  ]
}, {
  title: 'CM Team Member @ Mamram (May 2006 - Mar 2012)',
  content: [
  ...
  title: 'FullStack Developer @ Mamram (May 2006 - Mar 2012)',
  content: [
    ...
    'Lead performance analysis team using memory dumps investigation, load tests using HP Load Runner and Diagnostics (VUGen Scripting).',
...
export const Education = [{
  title: 'The Open University, Israel (2006 - 2014)',
  content: ['B,A. Computer Science - Systems & Appliactions.'],
}, {
  title: 'Mamram Programming School (2006)',
  content: ['Computer Science']
}, {
  title: 'Makif D, Ashdod (1999 - 2005)',
  content: [
    'High School, Computer Technology / Computer Systems Technology.',
    '5 units of English, Mathematics and Physics',
    '10 units of Computer Science'
  ]
}];
